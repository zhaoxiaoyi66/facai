...
def _system_ref_from_bundle(bundle, buy_zone_status: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "buyZoneContext": getattr(bundle, "buyZoneContext", {}),
        "buyZoneDisplay": getattr(bundle, "buyZoneDisplay", {}),
        "buyZoneAction": bundle.buyZoneAction,
        "buyZoneActionText": bundle.buyZoneActionText,
        "buyZonePrimaryZone": bundle.buyZonePrimaryZone,
        "buyZoneMainActionText": getattr(bundle, "mainActionText", ""),
        "sizingAction": getattr(bundle, "sizingAction", ""),
        "sizingActionText": getattr(bundle, "sizingActionText", ""),
