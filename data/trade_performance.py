...
def _snapshot_cost_basis_match(
    ...
    return {
        ...
        "sell_context_type": str(entry.get("sell_context_type") or ""),
        "sell_reason_tags": entry.get("sell_reason_tags"),
        "sell_reason_tag_list": list(entry.get("sell_reason_tag_list") or []),
        "fundamental_change_type": entry.get("fundamental_change_type"),
        "fundamental_change_types": list(entry.get("fundamental_change_types") or []),
        "valuation_compression_reason": str(entry.get("valuation_compression_reason") or ""),
        "liquidity_shock_reason": str(entry.get("liquidity_shock_reason") or ""),
        "position_risk_reason": str(entry.get("position_risk_reason") or ""),
        "sell_thesis_note": str(entry.get("sell_thesis_note") or ""),
