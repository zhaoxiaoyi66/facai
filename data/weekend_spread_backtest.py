    ...
    *,
    ...
    if provider is None:
        ...
        if supplemental.ok and supplemental.close is not None and supplemental.timestamp_et is not None:
            ...
            return {
                ...
                "bar_size": "1m",
                "returned_bar_count": 1,
                "raw_returned_bar_count": 1,
                "requested_start": start_et.astimezone(timezone.utc).isoformat(),
                "requested_end": requested_end.astimezone(timezone.utc).isoformat(),
                "raw_first_bar_time": supplemental.timestamp_et.astimezone(timezone.utc).isoformat(),
                "raw_first_bar_close": supplemental.close,
                "first_raw_bar_time": supplemental.timestamp_et.astimezone(timezone.utc).isoformat(),
                "first_raw_bar_close": supplemental.close,
        ...
        return {
            ...
            "bar_size": "1m",
            "returned_bar_count": 0,
            "raw_returned_bar_count": 0,
            "requested_start": start_et.astimezone(timezone.utc).isoformat(),
            "requested_end": requested_end.astimezone(timezone.utc).isoformat(),
            "raw_first_bar_time": "",
            "raw_first_bar_close": None,
            "first_raw_bar_time": "",
            "first_raw_bar_close": None,
            "first_raw_bar_time_et": "",
            "selected_bar_time": "",
    ...
    if result.get("ok"):
        ...
        return {
            ...
            "first_raw_bar_time": str(result.get("first_raw_bar_time") or result.get("raw_first_bar_time") or ""),
            "first_raw_bar_close": result.get("first_raw_bar_close", result.get("raw_first_bar_close")),
    ...
    result.update(
        {
            ...
            "stock_bar_raw_returned_count": int(stock_bar.get("raw_returned_bar_count") or stock_bar.get("returned_bar_count") or 0),
            ...
            "stock_bar_first_raw_time": str(stock_bar.get("first_raw_bar_time") or stock_bar.get("raw_first_bar_time") or ""),
            "stock_bar_first_raw_time_et": str(stock_bar.get("first_raw_bar_time_et") or ""),
    ...
    for interval in intervals:
        for anchor_name, day in attempts:
            ...
            attempt = {
                ...
                "raw_returned_bar_count": payload.get("raw_returned_bar_count", payload["returned_bar_count"]),
                ...
                "first_raw_bar_time": payload.get("first_raw_bar_time", payload.get("raw_first_bar_time", "")),
                "first_raw_bar_close": payload.get("first_raw_bar_close", payload.get("raw_first_bar_close")),
...
def _fetch_stock_open_bars(
    ...
    *,
    ...
    return {
        ...
        "raw_returned_bar_count": len(rows),
        ...
        "first_raw_bar_time": first_raw_bar.ts.astimezone(timezone.utc).isoformat() if first_raw_bar is not None else "",
        "first_raw_bar_close": first_raw_bar.close if first_raw_bar is not None else None,
        "first_raw_bar_time_et": first_raw_bar.ts.astimezone(ET).isoformat() if first_raw_bar is not None else "",
