...
class DashboardLayoutTests(unittest.TestCase):
    ...
    def test_dashboard_header_uses_clean_command_bar(self) -> None:
        ...
        self.assertIn("财报后刷新基本面", source)
        self.assertIn("RefreshMode.FUNDAMENTALS_IF_EVENT", source)
        self.assertIn("强制全量刷新", source)
        self.assertIn("RefreshMode.FULL_REFRESH", source)
        self.assertIn("刷新大盘环境", source)
        self.assertIn("RefreshMode.MACRO_ONLY", source)
...
class ScoringTests(unittest.TestCase):
    ...
    def test_score_explanation_panel_is_not_debug_table(self) -> None:
        ...
        self.assertIn("不等同于主表主击球区", source)
    ...
    def test_dashboard_drawer_labels_legacy_entry_reference(self) -> None:
        ...
        self.assertNotIn("_drawer_detail_basis_html", source)
        self.assertNotIn("_drawer_structure_entry_card_html", source)
        self.assertIn("_drawer_buy_plan_alert_html", source)
        self.assertIn("<details", detail_source)
        self.assertIn("详细依据", detail_source)
        self.assertIn("历史估值参考，仅供辅助", detail_source)
        self.assertIn("该参考不改变买入权限，买区建议以技术承接 buy_zone_context 为准", detail_source)
        self.assertIn("不等同于主表买区建议", detail_source)
        self.assertIn("历史估值参考", combined_source)
        self.assertIn("结构买入提示", structure_source)
        self.assertIn("只读提示，不改变主结论和账户层新增额度。", structure_source)
        ...
        self.assertIn("追高风险区", radar_card_source)
        ...
        self.assertIn("系统建议：等突破再评估", value_review_html)
        ...
        self.assertIn("技术回踩区与追高风险区重叠", overlap_html)
        ...
        self.assertIn("系统建议：追高风险提醒", chase_html)
        ...
        self.assertIn("只读提示，不改变主结论和账户层新增额度。", structure_html)
    ...
    def test_drawer_shows_decision_summary_and_position_guidance(self) -> None:
        ...
        self.assertIn("快速决策", html)
        self.assertIn("数据可信度低，先复核关键数据。", html)
        self.assertIn("计划买入提醒", html)
        self.assertIn("计划买入价", html)
        self.assertIn("计划买入股数", html)
        self.assertIn("查看完整研报", html)
        self.assertIn("记录当前信号", html)
        self.assertNotIn("详细依据", html)
        self.assertNotIn("Action Fusion", html)
        self.assertNotIn("历史估值参考", html)
        self.assertNotIn("行业专属指标", html)
